...
if "agent_executor" not in st.session_state:
    ...
    tools = [
        ...
        Tool(
            name="Wikipedia",
            func=wikipedia.run,
            description="Useful for factual questions about history, science, etc."
        ),
        Tool(
            name="SaveToFile",
            func=save_to_txt,
            description="Useful for saving research, findings, or summaries to a local text file"
        )
    ]
